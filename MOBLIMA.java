...
//==============================================================================================
        ArrayList<Cineplex> myCineplexList = new ArrayList<Cineplex>();
        Cineplex cineplex1 = new Cineplex("Cathay Cineplex AMK HUB");
        Cineplex cineplex2 = new Cineplex("Cathay Cineplex JEM");
        myCineplexList.add(cineplex1);
        myCineplexList.add(cineplex2);
        fileio.writeCineplexData(myCineplexList);

        ArrayList<Cinema> myCinemaList = new ArrayList<Cinema>();
        Cinema Cinema1 = new Cinema("Standard 1", myCineplexList.get(0), false, 100);
        Cinema Cinema2 = new Cinema("Standard 2", myCineplexList.get(1), false, 100); 
        myCinemaList.add(Cinema1);
        myCinemaList.add(Cinema2);
        fileio.writeCinemaData(myCinemaList);

        ArrayList<Cinema> myCinemaList2 = fileio.readCinemaData();
        for(int i = 0;i<myCinemaList2.size();i++){
            System.out.println(myCinemaList2.get(i).getCinemaName() + " and " + myCinemaList2.get(i).getCineplexName());
        }

        // ArrayList<Movie> myCinemaList = new ArrayList<Movie>();
        // Movie movie1 = new Movie("Standard 1", myCineplexList.get(0), false, 100);
        // Movie movie2 = new Movie("Standard 2", myCineplexList.get(0), false, 100); 
        // myCinemaList.add(Cinema1);
        // myCinemaList.add(Cinema2);
        // fileio.writeCinemaData(myCinemaList);
