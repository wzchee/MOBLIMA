...
public class updatedUser {
    ...
    public static void loggedin(String useremail) throws FileNotFoundException, IOException, Exception{
        ...
        int choice = 0;
        while(choice != 6){
            System.out.println("Welcome USER " + sessionUser.getName() + " !");
            ...
            switch(choice){
                case 1:
                    break;
                case 2:
                    MovieScreening movieScreeningToCheck = null;
                    movieScreeningToCheck.displayLayout();
                    break;
                case 3:
...
//=========================================================================================================
    ...
    public updatedUser(String email, String password, int age, String name, String mobileNumber){
        // constructor
        this.email = email;
    ...
    public static MovieTicket createBooking(MovieScreening movieScreeningOfChoice,int seatId,User userBooking,Double price) throws Exception{
